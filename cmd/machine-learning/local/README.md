...
./cmd/main ./cmd/machine-learning/local/machine-learning.yaml
# or, for mac osx
./cmd/main-osx ./cmd/machine-learning/local/machine-learning.yaml
```
...
# change to the cmd/machine-leaning/local directory
cd cmd/machine-learning/local
...
# update "hostPath" to be the full path of the local git clone directory + "/cmd/machine-learning/local", for e.g.,
#   "/Users/ankursoni/go/src/github.com/ankursoni/kubernetes-operator-roiergasias/cmd/machine-learning/local"
